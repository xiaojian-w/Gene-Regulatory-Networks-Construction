...
3. To make the code flexible, avoid directly writing specific file path or file name into functions, read path or file names by loading settings or 
...
```r
# combine the preprocess for TCGA
genotypePreprocess -> 
function(?){
	pinkProcess()
	imputationProcess()
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY3MjI1NDEyLC0yMDg3MjcwNDAyLDE1OD
