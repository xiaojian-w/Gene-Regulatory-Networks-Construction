...
4. For collaboration work, define the input and output format in detail of each block for other to reference. Withi
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIyODIwMjE0MSwtMjA4NzI3MDQwMiwxNT
